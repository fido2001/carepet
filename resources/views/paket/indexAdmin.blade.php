...
<div class="section-body">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4>Data Paket</h4>
            <a href="{{ route('create.paket.admin') }}" class="btn btn-success">Tambah Data Paket</a>
        </div>
        @if (session('success'))
        <div class="card-body">
                ...
                @foreach ($data_paket as $no => $paket)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('edit.paket.admin', $paket->id) }}" class="badge badge-info btn-edit">Ubah Data</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>

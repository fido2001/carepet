                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-md">
                                <tr>
                                    ...
                                    <th class="text-center">Durasi Pemesanan</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $pemesanan->durasi_pemesanan }} Hari</td>
                                    <td class="text-right">Rp. {{ $pemesanan->harga*$pemesanan->durasi_pemesanan }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-4 text-right">
                                {{-- <div class="invoice-detail-item">
                                    ...
                                    <div class="invoice-detail-value">Rp. {{ $pemesanan->harga*$pemesanan->durasi_pemesanan }}</div>
                                </div>
                                <div class="invoice-detail-item">
                            ...
                            <hr class="mt-2 mb-2">
                                <div class="invoice-detail-item">
                                    ...
                                    <div class="invoice-detail-value invoice-detail-value-lg"><h1>Rp. {{ $pemesanan->harga*$pemesanan->durasi_pemesanan }}</h1></div>
                                </div>
                            </div>
                        </div>
                    </div>
